...
typedef struct tnode{
    ...
    int nodetype;   // node type - // information about non-leaf nodes - constant-0/variable-1/read-2/write-3/connector-4/(+,*,-,/,<,>)-5/if-6/while-7/<=,>=,!=-8/then,else,endif-9/ do,endwhile -10 /break,continue-11/repeatuntilloop-12 /dowhileloop-13 etc.
